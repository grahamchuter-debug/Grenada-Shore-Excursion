#!/usr/bin/env python3
"""Generate /book/{slug}/ and /book/{slug}/received/ for Grenada Spice Route RTB.

Canonical URLs are extensionless without trailing slash (Grenada World 2.0 policy).
"""
...
from grenada_shell import footer_html, nav_html  # noqa: E402

PRODUCTS = [
    {
        "id": "grenadas-spice-route",
        "name": "Grenada's Spice Route",
        "product_path": "/grenada-spice-island-tours",
        "price_list": (
            "<li>Guests (ages 3+) — $89</li>"
            "<li>Ages 0–2 — not permitted on this excursion</li>"
        ),
        ...
        "truth": (
            "A guided half-day scenic and cultural excursion typically including Concord Falls, "
            "Gouyave, a traditional spice estate, and Grand Etang rainforest / crater lake context "
            "(mona monkeys may be seen — not guaranteed). Food and drinks are not included. "
            "Optional spice purchases are at your own cost. Moderate walking on mixed surfaces and inclines. "
            "This is not an Annandale Falls tour."
        ),
    },
]
...
def guest_fieldset(name: str) -> str:
    return f"""
        <fieldset class="booking-fieldset">
          ...
          <label for="adults">Guests (ages 3+) <span class="muted">— $89 each</span>
            <input type="number" name="adults" id="adults" min="1" max="10" value="2" required />
          </label>
          <p class="help">Ages 0–2 cannot participate. Guests under 16 must travel with a responsible adult in this party. Maximum 10 guests online. For larger groups email <a href="mailto:hello@grenadashoreexcursion.com">hello@grenadashoreexcursion.com</a>.</p>
        </fieldset>
        <div class="booking-review" id="booking-review" aria-live="polite">
          ...
          <dl>
            ...
            <div><dt>Guests (ages 3+)</dt><dd id="rev-adults">—</dd></div>
...
<head>
  ...
  <title>Book {name} | Grenada Shore Excursions</title>
  <meta name="description" content="Request {name} online. Pay securely to request — confirmation is emailed separately." />
  <link rel="canonical" href="https://grenadashoreexcursion.com/book/{pid}" />
...
<section class="section booking-flow">
  <div class="wrap booking-shell px-4 sm:px-6">
    ...
    <div class="booking-panel">
      ...
      <form class="booking-form" id="grd-booking-form" method="post" action="#" data-product-id="{pid}" data-live="0" novalidate>
        <fieldset class="booking-fieldset">
          ...
          <p class="help">Enter your ship and date. We do not invent a published Grenada ship-call schedule — availability is confirmed after your request.</p>
        </fieldset>
{guest_fieldset(name)}
        <fieldset class="booking-fieldset">
          ...
          <p class="help">The booking contact should be a responsible adult travelling with the party.</p>
        </fieldset>
        ...
        <label class="consent">
          <input type="checkbox" name="under16_ack" id="under16_ack" required />
          <span>I confirm that every guest under 16 travels with a responsible adult in this party, and that no guest under 3 is included.</span>
        </label>
        <label class="consent">
        ...
        <p class="help" id="booking-footer-note">Prefer to ask first? <a href="mailto:hello@grenadashoreexcursion.com">hello@grenadashoreexcursion.com</a></p>
      </form>
    </div>
  </div>
</section>
...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Booking request received | Grenada Shore Excursions</title>
  <meta name="description" content="Your Grenada excursion payment was received. This is a booking request, not a confirmation." />
  <link rel="canonical" href="https://grenadashoreexcursion.com/book/{pid}/received" />
  <meta name="robots" content="noindex,follow" />
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@500;600;700&amp;family=Source+Sans+3:wght@400;500;600;700&amp;display=swap" rel="stylesheet" />
...
<section class="section booking-flow">
  <div class="wrap booking-shell px-4 sm:px-6">
    ...
    <div class="booking-actions">
      ...
      <a class="btn btn--outline" href="mailto:hello@grenadashoreexcursion.com">Contact us</a>
    </div>
  </div>
</section>
